...
protected:
	...
	//nos indica el número de viewports que tenemos (pueden ser 1 o 4)
	static int numViewports;
	//nos indica si estamos o no en modo panorámico
	static bool modoPanoramico;
	//nos indica el modo de vista en el que estamos (axonométrico, alzado, planta o perfil)
	static int modo_vista;
	//matriz que almacena los puntos donde colocaremos la cámara, así como el vector arriba correspondiente
